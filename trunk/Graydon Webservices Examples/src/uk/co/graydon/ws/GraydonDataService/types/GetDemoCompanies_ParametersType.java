/**
 * GetDemoCompanies_ParametersType.java
 *
...
/**
 * All the request parameters for the 'getDemoCompanies' operation.
 */
public class GetDemoCompanies_ParametersType  implements java.io.Serializable {
    private uk.co.graydon.ws.GraydonDataService.types.Authentication_ParametersType authentication_Parameters;

    /* Specify the 'Country' parameter to return the demostration
     * companies for a single country. Omit this parameter and all countries
     * and their respective demostration companies are returned. */
    private java.lang.String country;

    public GetDemoCompanies_ParametersType() {
    }
    ...
    /**
     * Gets the authentication_Parameters value for this GetDemoCompanies_ParametersType.
     * 
    ...
    /**
     * Sets the authentication_Parameters value for this GetDemoCompanies_ParametersType.
     * 
    ...
    /**
     * Gets the country value for this GetDemoCompanies_ParametersType.
     * 
     * @return country   * Specify the 'Country' parameter to return the demostration
     * companies for a single country. Omit this parameter and all countries
     * and their respective demostration companies are returned.
     */
    ...
    /**
     * Sets the country value for this GetDemoCompanies_ParametersType.
     * 
     * @param country   * Specify the 'Country' parameter to return the demostration
     * companies for a single country. Omit this parameter and all countries
     * and their respective demostration companies are returned.
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetDemoCompanies_ParametersType)) return false;
        GetDemoCompanies_ParametersType other = (GetDemoCompanies_ParametersType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetDemoCompanies_ParametersType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.graydon.co.uk/GraydonDataService/types", "GetDemoCompanies_ParametersType"));
