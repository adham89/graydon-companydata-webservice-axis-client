/**
 * GetCompanyMatchMethods_ParametersType.java
 *
...
/**
 * All the request parameters for the 'getCompanyMatchMethods' operation.
 */
public class GetCompanyMatchMethods_ParametersType  implements java.io.Serializable {
    private uk.co.graydon.ws.GraydonDataService.types.Authentication_ParametersType authentication_Parameters;

    /* Specify the 'Country' parameter and 'MatchMethods' for a single
     * country will be in the response. No 'Country' parameter specified
     * and 'MatchMethods' for every available online country will be returned. */
    private java.lang.String country;

    public GetCompanyMatchMethods_ParametersType() {
    }
    ...
    /**
     * Gets the authentication_Parameters value for this GetCompanyMatchMethods_ParametersType.
     * 
    ...
    /**
     * Sets the authentication_Parameters value for this GetCompanyMatchMethods_ParametersType.
     * 
    ...
    /**
     * Gets the country value for this GetCompanyMatchMethods_ParametersType.
     * 
     * @return country   * Specify the 'Country' parameter and 'MatchMethods' for a single
     * country will be in the response. No 'Country' parameter specified
     * and 'MatchMethods' for every available online country will be returned.
     */
    ...
    /**
     * Sets the country value for this GetCompanyMatchMethods_ParametersType.
     * 
     * @param country   * Specify the 'Country' parameter and 'MatchMethods' for a single
     * country will be in the response. No 'Country' parameter specified
     * and 'MatchMethods' for every available online country will be returned.
     */
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetCompanyMatchMethods_ParametersType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://ws.graydon.co.uk/GraydonDataService/types", "GetCompanyMatchMethods_ParametersType"));
